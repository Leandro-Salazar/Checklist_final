...
app.post('/api/enviar-formulario', async (req, res) => {
  try {
    ...
    const columnValues = {
      ...
      text_mkpnrmd0: respostas[2],
      text_mkpn766e: respostas[3],
      text_mkpnn53k: respostas[4],
      text_mkpnxs2v: respostas[5],
      text_mkpnza93: respostas[6],
      text_mkpnzzsa: respostas[7],
      text_mkpncg6g: respostas[8],
      text_mkpnj2z2: respostas[9],
      text_mkpn67sw: respostas[10],
      text_mkpntpbk: respostas[11],
      text_mkpndc5k: respostas[12],
      text_mkpn1nf1: respostas[13],
      text_mkpnc0wq: respostas[14],
      text_mkpnh13t: respostas[15],
      text_mkpn5rsk: respostas[16],
      text_mkpna61f: respostas[17],
      text_mkpntay0: respostas[18],
      text_mkpntemc: respostas[19],
      text_mkpnfbbb: respostas[20],
      text_mkpn3qcd: respostas[21],
      text_mkpnqmth: respostas[22],
      text_mkpncnc3: respostas[23],
    };
